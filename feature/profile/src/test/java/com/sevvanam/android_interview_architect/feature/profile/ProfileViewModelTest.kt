...
class ProfileViewModelTest {
    ...
    fun `userProfile emits the value from GetUserProfileUseCase`() = runTest {
        ...
        val viewModel = ProfileViewModel(getUserProfileUseCase, updateBioUseCase, toggleNotificationsUseCase, setThemeModeUseCase)
    ...
    @Test
    fun `setThemeMode delegates to SetThemeModeUseCase`() = runTest {
        every { getUserProfileUseCase() } returns flowOf(profile)
        ...
        coVerify { setThemeModeUseCase("dark") }
    }
}
